            ...
            <div id="infoPanel">
                <div id="bizSearch" class="form-group">
                    <form class="form-inline">
                        ...
                        <p><b>By: </b><label>Business Name: <input id="searchName" type="radio" name="searchType" value="name" checked></label>
                        <label>Business Keywords: <input id="searchKeyword" type="radio" name="searchType" value="keyword"></label></p>
                    </form>
                </div>
