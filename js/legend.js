...
function setLegend() {
    ...
    for (var label in markerLabels) {
        ...
        div.innerHTML = '<p><span class="legend-icon"><input type="checkbox" id="'+id[0]+'" checked="checked"></span>' +
            '<span class="legend-icon" style="color:' + categoryColors[label] + '">' + icon + '  </span>' +
